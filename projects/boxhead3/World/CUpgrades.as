...
if(!_global.World.CUpgrades)
{
    ...
    {
        this.mTick++;
        var _loc4_ = !this.mWorld.mThing_Collection.mThingCounters.CThing_Creature_Devil && !this.mWorld.mThing_Collection.mThingCounters.CThing_Creature_Zombie;
        if(this.Level.Zombie_Count <= 0 && this.Level.Devil_Count <= 0 && _loc4_)
        {
    ...
    _loc2_.AddUpgrade = function AddUpgrade(tName, tClassID, tProp, tValue)
    {
        ...
        if(tValue != true)
        {
            var _loc2_ = this.mWorld.mThing_Collection.SearchThings("_CLASSID_","CThing_Creature_Player");
