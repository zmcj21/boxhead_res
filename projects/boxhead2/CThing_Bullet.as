class CThing_Bullet extends CThing_Shot
{
    ...
    function CThing_Bullet(tPosition, tAngle, tID, tOwner, tDamage, tRange)
    {
        ...
        _loc4_.Normalize(CMapwho.mCellSize.x * tRange);
        ...
        if(_loc3_ != undefined)
        {
            if(_loc3_.mThing != undefined)
            {
                ...
                _loc3_.mThing.AddAffect(CThing_Affect.Bullet(this.mOwner,this,this.mDamage,this.mAngle));
            }
    ...
    function Draw()
    {
        CCity._this.DrawLine(this.mPosition,this.mDestination,1,13421772,this.mAlpha);
        this.mAlpha -= 15;
    }
}
