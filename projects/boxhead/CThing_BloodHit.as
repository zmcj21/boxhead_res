class CThing_BloodHit extends CThing_Effect
{
    ...
    function CThing_BloodHit(tPosition, tAngle, tID, tOwner)
    {
        ...
        {
            CThing_BloodHit.mcBloodHit = _root.attachMovie("BloodHit","_BloodHit",_root.getNextHighestDepth(),{_visible:false});
            CThing_BloodHit.mcBloodHit.mScale = 0.5;
        }
        this.mOwner = tOwner;
    ...
    function Process()
    {
        ...
        this.Move(_loc2_);
        this.mFrameIndex++;
        if(this.mFrameIndex >= CThing_BloodHit.mcBloodHit._Front._totalframes + 1)
        {
