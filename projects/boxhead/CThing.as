class CThing
{
    ...
    {
        var _loc1_ = new flash.geom.Point((tPosition.mX - CCity._this.mScreenCentre.x) / CCity._this.mScreenSizeHalf.x / 2,(tPosition.mY - CCity._this.mScreenCentre.y) / CCity._this.mScreenSizeHalf.y);
