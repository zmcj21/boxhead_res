class Thing.Weapon.CThing_Weapon_Shotgun extends Thing.Weapon.CThing_Weapon
{
    ...
    function Fire(tPosition, tAngle)
    {
        ...
        var _loc4_ = _loc5_;
        while(0 <= (!this.mWideShot ? 0 : 1))
        {
            this.mThing_Collection.AddThing_Shot(new Thing.Shot.CThing_Shot_Bullet(tPosition.Clone(),new Thing.Math.CThing_Angle(tAngle.__get__mAngle() - _loc4_ * 3.141592653589793 / 180),_loc8_,this.mDamage,_loc6_,false));
            this.mThing_Collection.AddThing_Shot(new Thing.Shot.CThing_Shot_Bullet(tPosition.Clone(),new Thing.Math.CThing_Angle(tAngle.__get__mAngle() + _loc4_ * 3.141592653589793 / 180),_loc8_,this.mDamage,_loc6_,false));
            1;
            0;
            _loc4_ += _loc5_;
