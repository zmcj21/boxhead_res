class World.Map.CMap
{
    ...
    function CMap(tWorld)
    {
        ...
        trace("-------- mSize = " + this.mSize);
        trace("-------- mWorld.mArea.size = " + this.mWorld.mArea.size);
        trace("-------- mWorld.mcRoomData._Size._width = " + this.mWorld.mcRoomData._Size._width);
        trace("-------- mWorld.mcRoomData._Size._height = " + this.mWorld.mcRoomData._Size._height);
        this.InitCells();
