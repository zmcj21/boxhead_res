class Thing.Shot.CThing_Shot_FireBall extends Thing.Shot.CThing_Shot
{
    ...
    function Process_Normal()
    {
        ...
        if(this.oCollide.GenericCollide(this))
        {
            ...
            this.mWorld.mMap.mAffect.AffectArea(_loc2_,!this.mDamageMultiply ? new Thing.Affect.CThing_Affect_Bullet(this.mParent,this,this.mDamage,this.mAngle) : new Thing.Affect.CThing_Affect_DevilAttack(this.mParent,this,10000,this.mAngle));
            this.Delete();
            return undefined;
        }
