...
if(!_global.Thing.Math.CThing_Angle)
{
    ...
    _loc2_.__get__mDirection = function __get__mDirection()
    {
        return Math.round(this.mRadians / Thing.Math.CThing_Angle.mRadsToDirection) & 7;
    };
    _loc2_.__set__mDirection = function __set__mDirection(d)
    {
    ...
    _loc2_.__set__mDelta = function __set__mDelta(d)
    {
        this.mRadians = Thing.Math.CThing_Angle.Correct(Math.atan2(d.mY,d.mX));
        return this.__get__mDelta();
    };
    _loc2_.__get__mDirectionDelta = function __get__mDirectionDelta()
    {
        return Thing.Math.CThing_Angle.mDirection_Deltas[this.__get__mDirection()];
    };
    _loc2_.__set__mDirectionDelta = function __set__mDirectionDelta(d)
    {
        this.mRadians = Thing.Math.CThing_Angle.Correct(Math.atan2(d.mY,d.mX));
        return this.__get__mDirectionDelta();
    };
    _loc2_.__get__mDirectionDeltaOpposite = function __get__mDirectionDeltaOpposite()
    {
        return Thing.Math.CThing_Angle.mDirection_Deltas[this.__get__mDirectionOpposite()];
    };
    _loc2_.__get__mAngle256 = function get mAngle256()
    {
        return this.mRadians * Thing.Math.CThing_Angle.RadsTo256 & 255;
    };
    Thing.Math.CThing_Angle = function(a)
    {
        this.mRadians = Thing.Math.CThing_Angle.Correct(a);
    ...
    {
        this.mRadians = Thing.Math.CThing_Angle.Correct(a);
    }.RadsTo256 = 256 / Thing.Math.CThing_Angle.PI360;
    Thing.Math.CThing_Angle = function(a)
    {
        this.mRadians = Thing.Math.CThing_Angle.Correct(a);
    }.mDirection_E = 0;
    ...
    §§push(_loc2_.addProperty("mAngle256",_loc2_.__get__mAngle256,0));
