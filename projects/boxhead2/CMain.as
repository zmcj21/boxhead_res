class CMain extends MovieClip
{
    ...
    static var mState_SelectArena = 7;
    ...
    function CMain()
    {
        ...
        this.AddScreen("Screen.SelectArena",CMain.mState_SelectArena);
            ...
            if((_loc0_ = this.mState) !== CMain.mState_Init)
            {
                if(_loc0_ !== CMain.mState_Intro)
                {
                    if(_loc0_ !== CMain.mState_Main)
                    {
                        ...
                        {
                            if(_loc0_ !== CMain.mState_SelectArena)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        this.mcCity = this.attachMovie("City","_City",this.getNextHighestDepth(),{});
    ...
    function ProcessFrames(tFrameRate)
    {
        ...
        {
            this.mTimeSlice = 4847;
            return 1;
        }
        this.mTimeSlice = this.mTimeSlice != undefined ? this.mTimeSlice : getTimer();
        var _loc2_ = int((1038 - this.mTimeSlice) / (1000 / tFrameRate));
        if(_loc2_ > 0)
        {
