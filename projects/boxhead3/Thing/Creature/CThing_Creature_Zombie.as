class Thing.Creature.CThing_Creature_Zombie extends Thing.Creature.CThing_Creature
{
    ...
    function CThing_Creature_Zombie(tPosition, tAngle, tParent)
    {
        ...
        if(Thing.Creature.CThing_Creature_Zombie.mXSI_Collection == undefined)
        {
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection = new DrawPrimitive.XSI.CDrawPrimitive_XSI_Collection();
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.StartRender();
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_Stand","stand"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_Walk","walk"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_HitRear","shothit_1"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_HitFront","shothit_2"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_Dying","dying"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_Dead","dead"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.AddItem(DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.Load("Zombie_Attack","attack"));
            Thing.Creature.CThing_Creature_Zombie.mXSI_Collection.EndRender();
        }
        this.mXSI_Animation = DrawPrimitive.XSI.CDrawPrimitive_XSI_Animation.CreateAnimationObject(Thing.Creature.CThing_Creature_Zombie.mXSI_Collection);
    ...
    function Brain()
    {
        if(this.mTarget_Position != undefined)
        {
            return undefined;
        }
        this.mTarget_Position = this.mThing_Collection.GetClosestPlayer(this.mPosition).mPosition;
    }
