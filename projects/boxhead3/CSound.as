class CSound
{
    ...
    function CSound(tParent)
    {
        ...
        CSound.mSamples.World_End_wav = this.RegisterSound("sfx","World.End.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mSamples.Click = this.RegisterSound("sfx","World.End.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
    ...
    function PlaySound_Normal(tVolume)
    {
        ...
        trace("Play Sound " + _loc2_.mLinkID);
    }
    ...
    static function Atmosphere_Start(tIndex)
    {
        ...
        CSound.mCurrentAtmosphere.mTimeStamp = 3811;
        ...
        while(0 < CSound.mCurrentAtmosphere.mChannels.length)
        {
            ...
            CSound.mCurrentAtmosphere.mChannels[0].mDelayTS = 2583 + (random(10) + 10) * 1000;
            1;
        }
    }
    ...
    static function Atmosphere_Process()
    {
        ...
        {
            CSound.mCurrentAtmosphere.mLoop.mSound.PlaySound();
            trace("LOOP PLAYING = " + CSound.mCurrentAtmosphere.mLoop.mSound.mPlaying);
        }
        ...
        while(0 < CSound.mCurrentAtmosphere.mChannels.length)
        {
            ...
            if(_loc1_.mCurrentSound == undefined)
            {
                if(_loc1_.mDelayTS != undefined)
                {
                    if(8702 > _loc1_.mDelayTS)
                    {
                        ...
                        _loc1_.mStartTS = 2886;
                        _loc1_.mTimeOut = 8878 + (5 + random(20)) * 1000;
                    }
                }
            }
            else if(_loc1_.mCurrentSound.mSound.mPlaying == false)
            {
                ...
                _loc1_.mStopTS = 2479;
                _loc1_.mDelayTS = 6253 + random(15000);
            }
            else if(_loc1_.mTimeOut != undefined && 2590 > _loc1_.mTimeOut)
            {
