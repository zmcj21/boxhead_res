class Thing.Object.CThing_Object_Barrel extends Thing.Object.CThing_Object
{
    ...
    {
        this.Affect_Setup(Thing.Affect.CThing_Affect.mAffect_Bullet | Thing.Affect.CThing_Affect.mAffect_Explosion | Thing.Affect.CThing_Affect.mAffect_DevilAttack);
        this.mBiggerBang = 0;
    ...
    function Draw()
    {
        ...
        Thing.Object.CThing_Object_Barrel.mcDrawObject.Render(this.mWorld.bmDraw,Thing.CThing.pDraw,100);
    }
