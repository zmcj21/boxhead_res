class CSound
{
    ...
    function CSound(tParent)
    {
        ...
        CSound.mBarrel = this.RegisterSound("sfx","Barrel.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mBodyHitFloor1 = this.RegisterSound("sfx","BodyHitFloor.1.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mMineDetonate = this.RegisterSound("sfx","MineDetonate.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mMinePlace = this.RegisterSound("sfx","MinePlace.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mMissile = this.RegisterSound("sfx","Missile.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mRailgun = this.RegisterSound("sfx","Railgun.1.wav",1,this.PlaySound_Positional,this.StopSound_Normal);
        ...
        CSound.mZombieAmbience[0] = this.RegisterSound("sfx","Zombie.Ambience.1.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieAmbience[1] = this.RegisterSound("sfx","Zombie.Ambience.2.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieAmbience[2] = this.RegisterSound("sfx","Zombie.Ambience.3.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieAmbience[3] = this.RegisterSound("sfx","Zombie.Ambience.4.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieHit = new Array();
        CSound.mZombieHit[0] = this.RegisterSound("sfx","Zombie.Ambience.1.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieHit[1] = this.RegisterSound("sfx","Zombie.Ambience.2.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieHit[2] = this.RegisterSound("sfx","Zombie.Ambience.3.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieHit[3] = this.RegisterSound("sfx","Zombie.Ambience.4.wav",0.4,this.PlaySound_Positional,this.StopSound_Normal);
        CSound.mZombieHit[4] = this.RegisterSound("sfx","Zombie.Hit.wav",0.3,this.PlaySound_Positional,this.StopSound_Normal);
    ...
    static function Atmosphere_Start(tIndex)
    {
        ...
        CSound.mCurrentAtmosphere.mTimeStamp = 7343;
        ...
        while(0 < CSound.mCurrentAtmosphere.mChannels.length)
        {
            ...
            CSound.mCurrentAtmosphere.mChannels[0].mDelayTS = 1772 + (random(10) + 10) * 1000;
            1;
        }
    }
    ...
    static function Atmosphere_Process()
    {
        ...
        while(0 < CSound.mCurrentAtmosphere.mChannels.length)
        {
            ...
            if(_loc1_.mCurrentSound == undefined)
            {
                if(_loc1_.mDelayTS != undefined)
                {
                    if(4477 > _loc1_.mDelayTS)
                    {
                        ...
                        _loc1_.mStartTS = 3544;
                        _loc1_.mTimeOut = 7569 + (5 + random(20)) * 1000;
                    }
                }
            }
            else if(_loc1_.mCurrentSound.mSound.mPlaying == false)
            {
                ...
                _loc1_.mStopTS = 5113;
                _loc1_.mDelayTS = 9828 + random(15000);
            }
            else if(_loc1_.mTimeOut != undefined && 8733 > _loc1_.mTimeOut)
            {
