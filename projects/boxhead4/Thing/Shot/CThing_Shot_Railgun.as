class Thing.Shot.CThing_Shot_Railgun extends Thing.Shot.CThing_Shot
{
    var _CLASSID_ = "CThing_Shot_Railgun";
    static var pDraw = new flash.geom.Point();
    function CThing_Shot_Railgun(tPosition, tAngle, tParent, tDamage, tRange)
    {
    ...
    function Draw()
    {
        ...
        DrawPrimitive.CDrawPrimitive_Line.Draw(this.mWorld.mcScratch,_loc3_,_loc2_,2,10053375,this.mAlpha * 0.75);
    }
}
