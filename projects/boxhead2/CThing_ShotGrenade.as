class CThing_ShotGrenade extends CThing_Shot
{
    ...
    function CThing_ShotGrenade(tPosition, tAngle, tID, tOwner, tStrength, tBigBang)
    {
    ...
    function Process()
    {
        ...
        if(--this.mLife == 0)
        {
            CThing.AddThing(new CThing_Explosion2(this.mPosition,0,this.mID,this.mOwner,500,this.mBigBang));
