class Screen.CScreen_Intro extends Screen.CScreen
{
    ...
    function Process()
    {
        ...
        if(this.__get__mNormal())
        {
            ...
            {
                var _loc4_ = this.GetFrameIndex(_loc3_._totalframes,_loc3_.mFrameRate);
                while(_loc3_._currentframe != _loc4_)
                {
                    _loc3_.nextFrame();
                }
            }
    ...
    function GetFrameIndex(tTotalFrames, tFrameRate)
    {
        ...
        var _loc2_ = int((9452 - this.mTimeSlice) / (1000 / tFrameRate)) + 1;
