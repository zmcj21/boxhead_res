class CThing_Animation extends CThing_Move
{
    ...
    function CThing_Animation(tPosition, tAngle, tID)
    {
        ...
        this.mDrawPosition = new flash.geom.Point();
    }
    static function Renew()
    {
        ...
        CThing_Animation.Init_XSIAnimationSets();
    }
    static function Init_XSIAnimationSets()
    {
        if(CThing_Animation.mAnimationSets != undefined)
        {
            return undefined;
        }
        CThing_Animation.mAnimationSets = new Object();
        var _loc2_ = CThing_Animation.mAnimationSets;
        var _loc3_ = _root._quality;
        _root._quality = "HIGH";
        _loc2_.Player = new CXSIAnimation();
        _loc2_.Player_UZI = new CXSIAnimation();
        _loc2_.Zombie = new CXSIAnimation();
        _loc2_.Devil = new CXSIAnimation();
        _loc2_.EvilGirl = new CXSIAnimation();
        _loc2_.Zombie.Load("Zombie_Stand","stand");
        _loc2_.Zombie.Load("Zombie_Walk","walk");
        _loc2_.Zombie.Load("Zombie_HitRear","shothit_1");
        _loc2_.Zombie.Load("Zombie_HitFront","shothit_2");
        _loc2_.Zombie.Load("Zombie_Dying","dying");
        _loc2_.Zombie.Load("Zombie_Dead","dead");
        _loc2_.Zombie.Load("Zombie_Attack","attack");
        _loc2_.Player.Load("Player_Idle1","idle");
        _loc2_.Player.Load("Player_Stand","stand");
        _loc2_.Player.Load("Player_Walk","walk");
        _loc2_.Player.Load("Player_HitRear","shothit_1");
        _loc2_.Player.Load("Player_HitFront","shothit_2");
        _loc2_.Player.Load("Player_Dying","dying");
        _loc2_.Player.Load("Player_Dead","dead");
        _loc2_.Player.Load("Player_Handgun_WalkAim","pistolwalk");
        _loc2_.Player.Load("Player_Handgun_StandAim","pistolstand");
        _loc2_.Player.Load("Player_Shotgun_WalkAim","shotgunwalk");
        _loc2_.Player.Load("Player_Shotgun_StandAim","shotgunstand");
        _loc2_.Player.Load("Player_UZI_WalkAim","uziwalk");
        _loc2_.Player.Load("Player_UZI_StandAim","uzistand");
        _loc2_.Player.Load("Player_Rocket_WalkAim","rocketlauncherwalk");
        _loc2_.Player.Load("Player_Rocket_StandAim","rocketlauncherstand");
        _loc2_.Player.Load("Player_FlameThrower_WalkAim","flamethrowerwalk");
        _loc2_.Player.Load("Player_FlameThrower_StandAim","flamethrowerstand");
        _loc2_.Player.Load("Player_Railgun_WalkAim","railgunwalk");
        _loc2_.Player.Load("Player_Railgun_StandAim","railgunstand");
        _loc2_.Player.Load("Player_Tazor_WalkAim","lightningwalk");
        _loc2_.Player.Load("Player_Tazor_StandAim","lightningstand");
        _loc2_.Player.Mimic("grenadewalk","walk");
        _loc2_.Player.Mimic("grenadestand","stand");
        _loc2_.Player.Mimic("barrelwalk","walk");
        _loc2_.Player.Mimic("barrelstand","stand");
        _loc2_.Player.Mimic("claymorewalk","walk");
        _loc2_.Player.Mimic("claymorestand","stand");
        _root._quality = _loc3_;
        CCity.XSI_Info = _loc2_.Player.XSI_Info;
    }
    function toString()
    {
    ...
    {
        if(++this.mState_Count == 3)
        {
            this.PlaySound(CSound.mBodyHitFloor1);
        }
        if(this.Animate(0.25))
        {
            this.SetState(CThing_Animation.mState_Dead);
            delete this.mMapColor;
            this.mState_Count = this._CLASSID_ != "CThing_Player" ? 80 : 200;
        }
    }
    function fState_ZombieAttack()
    {
        if(this.Animate(0.2 * (this.mSpeed * 1.5)))
        {
    ...
    {
        if(this.mState_Count < 50)
        {
            this.mAlpha = this.mState_Count * 2;
    ...
    function SetState(nState)
    {
        ...
        switch(this.mState = nState)
        {
            ...
            case CThing_Animation.mState_TurnToDirection:
                ...
                this.SetAnimation("stand");
                var _loc4_ = Math.abs(this.mNewDirection - this.mDirection) <= 4 ? 1 : -1;
                this.mTurnDirection = this.mNewDirection <= this.mDirection ? 0 - _loc4_ : _loc4_;
                this.mState_Count = 0;
                break;
            ...
            case CThing_Animation.mState_GotoFinalPosition:
                ...
                var _loc6_ = new flash.geom.Point(CCity._this.mCivilianDestinationPosition.mX >> CMapwho.mCellSizeShift,CCity._this.mCivilianDestinationPosition.mY >> CMapwho.mCellSizeShift);
                var _loc5_ = new flash.geom.Point(this.mPosition.mX >> CMapwho.mCellSizeShift,this.mPosition.mY >> CMapwho.mCellSizeShift);
            ...
            case CThing_Animation.mState_Dying:
                ...
                switch(this._CLASSID_)
                {
                    case "CThing_Civilian":
                        ...
                        break;
                    case "CThing_Zombie":
                        CHud.ZombieKill(CCity._DrawPosition(this.mPosition));
                        if(CHud._this.mThisKillCount / 5 % 1 == 0)
                        {
                            CThing.AddThing(new CThing_Crate(CMapwho.CentrePosition(this.mPosition),0,undefined,"randomanddelete"));
                            break;
                        }
                }
                break;
            ...
            case CThing_Animation.mState_ZombieHit:
                ...
                CThing.AddThing(new CThing_BloodHit(this.mPosition.Add(new scidd.Math.CPointXYZ(0,0,random(20) + 10)),this.mHitAngle,this.mID,this));
                break;
    ...
    function Collide(p, d, collideFlags)
    {
        ...
        var _loc7_ = _loc2_._QCollide(_loc3_.x,_loc5_.y);
        var _loc8_ = _loc2_._QCollide(_loc5_.x,_loc3_.y);
        var _loc10_ = _loc2_._QCollide(_loc3_.x,_loc3_.y);
    ...
    {
        this.mAnim.SetAnimation(tAnim,this.mAngle,fIndex);
    }
    function Animate(tTick)
    {
        return this.mAnim.Animate(this.mAngle,tTick != undefined ? tTick : 0.125);
    }
    ...
    {
        this.mDrawn = true;
        this.mDrawPosition.x = this.mPosition.mX - CCity.mDrawPosition.x;
        this.mDrawPosition.y = 0 - this.mPosition.mZ + this.mPosition.mY - CCity.mDrawPosition.y;
        this.mAnim.Render(this.mDrawPosition,this.mAlpha);
    }
    ...
    function MoveInDirectionFlags(p, tDirection)
    {
        ...
        return !(tDirection & 1) ? _loc4_._QCollide(p.x + _loc2_.x,p.y + _loc2_.y) : _loc4_._QCollide(p.x + _loc2_.x,p.y) | _loc4_._QCollide(p.x,p.y + _loc2_.y) | _loc4_._QCollide(p.x + _loc2_.x,p.y + _loc2_.y);
    }
